  ...
  template: `
    ...
    >
      <div 
        ...
        class="bg-red-500 hover:bg-red-600 active:bg-red-700 text-white rounded-full p-4 sm:p-4 shadow-lg cursor-pointer transition-all duration-200 flex items-center justify-center size-20 sm:size-16 touch-target"
        :class="{ 
      ...
      <!-- Mobile help text -->
      <div class="absolute -top-12 right-0 bg-black bg-opacity-75 text-white text-xs px-2 py-1 rounded opacity-0 transition-opacity duration-200 whitespace-nowrap sm:hidden"
           :class="{ 'opacity-100': selectedChore && !selectedChore.isNewFromQuicklist }"
