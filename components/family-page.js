      ...
      <div class="bg-white rounded-lg border border-gray-200 p-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
          <div 
            ...
            :key="person.id"
            class="family-card rounded-lg p-4 hover:shadow-md transition-shadow"
          >
            <div class="flex items-center justify-between mb-3">
              <div class="flex items-center gap-3">
                <div class="family-avatar rounded-full w-10 h-10 flex items-center justify-center font-bold text-lg">
            ...
            <div class="space-y-2">
              <div class="flex justify-between items-center">
                <span class="text-sm text-secondary-custom">Electronics Status:</span>
                <span 
                  :class="person.electronicsStatus.status === 'allowed' ? 'text-emerald-600' : 'text-red-600'"
        ...
        <div v-if="people.length === 0" class="text-center py-8 text-secondary-custom">
